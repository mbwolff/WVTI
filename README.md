...
The code can also produce comparable results in English with the nearly [3,000,000 tweets by Russian trolls](https://github.com/fivethirtyeight/russian-troll-tweets) posted by [FiveThirtyEight](https://fivethirtyeight.com).
